...
class Quiche(RandomFileExperiment):
    ...
    CLIENT = "/home/bolong/quiche-multipath/quiche/apps/src/bin/send_same/quiche-client"
    SERVER = "/home/bolong/quiche-multipath/quiche/apps/src/bin/send_same/quiche-server"
